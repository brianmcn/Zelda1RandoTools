...
let hintMeanings = [|
    ...
    |]
let hintMeaningsDecriptionTextForUI = hintMeanings |> Array.map (fun (x,y) -> y + "\n" + x)

let vanilla1QDungeonLocations = [| 7,3; 12,3;  4,7;  5,4; 11,0; 2,2;  2,4; 13,6; 5,0 |]
